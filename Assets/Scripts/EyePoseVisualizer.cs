...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    {
        [SerializeField]
        GameObject L_m_EyePrefab;
        [SerializeField]
        GameObject R_m_EyePrefab;


        public GameObject m_LeftEyeGameObject;
        public GameObject m_RightEyeGameObject;
        ...
        void CreateEyeGameObjectsIfNecessary()
        {
            ...
            {
                m_LeftEyeGameObject = Instantiate(L_m_EyePrefab, m_Face.leftEye);
                m_LeftEyeGameObject.SetActive(false);
            }
            if (m_Face.rightEye != null && m_RightEyeGameObject == null)
            {
                m_RightEyeGameObject = Instantiate(R_m_EyePrefab, m_Face.rightEye);
